   ...
   <body>
      <div class="preloader">
         <div class="loader">
            ...
            <span><?php  echo $this->lang->line('1') ?></span>
         </div>
      </div>
               ...
               <nav class="navbar navbar-expand-md navbar-light">
                  ...
                  <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                     ...
                     <div class="others-option-vg d-flex align-items-center">
                        ...
                        <div class="option-item">
                           <a href="<?php echo base_url('hotel/viewtable');?>" class="default-btn"><?php  echo $this->lang->line('2') ?></a>
                        </div>
                        <div style ='margin:0 auto; text-align:center'>
                           <a href="<?php echo base_url("hotel/switchLang/english"); ?>">English</a> |
                           <a href="<?php echo base_url("hotel/switchLang/french"); ?>">French</a> |
                           <a href="<?php echo base_url("hotel/switchLang/german"); ?>">German</a> |
                           <a href="<?php echo base_url("hotel/switchLang/spanish"); ?>">Spanish</a>
                       </div>
                     </div>
                  </div>
               </nav>
               ...
               <div class="container">
                  <div class="option-inner">
                     <div class="others-option justify-content-center d-flex align-items-center">
                        ...
                        <div class="option-item">
                           <a href="booking-table.php" class="default-btn"><?php  echo $this->lang->line('1') ?></a>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="row align-items-center">
               <div class="col-lg-6">
                  <div class="single-banner-content">
                     <span data-cue="slideInUp" data-duration="800"><?php  echo $this->lang->line('3') ?></span>
                     <h1 data-cue="slideInUp" data-duration="1800" style="font-size: 40px !important;"><?php  echo $this->lang->line('4') ?></h1>
                     <p data-cue="slideInUp" data-duration="2000"><?php  echo $this->lang->line('5') ?></p>
                     <a href="about.php" class="default-btn" data-cue="slideInUp" data-duration="2500"><?php  echo $this->lang->line('6') ?></a>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-lg-3 col-sm-6 col-md-6" data-cue="slideInUp">
                  <div class="single-discover-card">
                     ...
                     <p><?php  echo $this->lang->line('8') ?></p>
                     <a href="#" class="discover-more"><?php  echo $this->lang->line('9') ?></a>
                  </div>
               </div>
               <div class="col-lg-3 col-sm-6 col-md-6" data-cue="slideInUp">
                  <div class="single-discover-card">
            ...
            <div class="row align-items-center">
               <div class="col-lg-6" data-cue="slideInLeft" data-duration="800">
                  <div class="about-image">
                     <img src="<?php echo base_url();?>frontend/images/about/about-img-1.webp" alt="images">
                  </div>
               </div>
               <div class="col-lg-6" data-cue="slideInRight" data-duration="800">
                  <div class="single-about-content">
                     <div class="section-title left-title">
                        <span class="top-title"><?php  echo $this->lang->line('12') ?></span>
                        <h2><?php  echo $this->lang->line('13') ?></h2>
                        <p><?php  echo $this->lang->line('14') ?>
                        </p>
                     </div>
                     <div class="row">
                     ...
                     <ul>
                        ...
                        <li><i class='bx bx-right-arrow-circle'></i><?php  echo $this->lang->line('17') ?></li>
                     </ul>
      ...
      <div class="special-menu-area pt-100 pb-100">
         <div class="container">
            <div class="section-title">
               <span class="top-title"><?php  echo $this->lang->line('18') ?></span>
               <h2><?php  echo $this->lang->line('19') ?></h2>
            </div>
            <div class="special-menu-tabs">
               <ul class="nav nav-tabs" id="myTab" role="tablist">
                 ...
                 <!--  <li class="nav-item" role="presentation">
                     <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Appetizers</button>
                  </li>
                  <li class="nav-item" role="presentation">
               ...
               <div class="tab-content" id="myTabContent">
                  ...
                  <!-- <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                     <div class="single-special-menu-content">
                        <div class="row">
                           <?php $s=0; foreach ($cat_items as $key => $cat_item) { ?>
                           <div class="col-lg-6 col-md-6">
                              <div class="special-card">
                                 <div class="row align-items-center">
                                    <div class="col-lg-3 col-4">
                                       <div class="special-menu-img">
                                         <img src="<?php echo base_url($cat_item->ProductImage);?>" alt="images">
                                       </div>
                                    </div>
                                    <div class="col-lg-6 col-6">
                                       <div class="special-menu-text">
                                          <h3><?php echo $cat_item->ProductName; ?></h3>
                                          <p><?php echo $cat_item->descrip; ?></p>
                                          <br>
                              ...
                              <div class="special-card">
                                 <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-6">
                                       <div class="special-menu-text">
                                          <a href="menu-details.html">
                                             <h3><?php  echo $this->lang->line('21') ?></h3>
                                          </a>
                              ...
                              <div class="special-card">
                                 <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-6">
                                       <div class="special-menu-text">
                                          <a href="menu-details.html">
                                             <h3><?php  echo $this->lang->line('23') ?></h3>
                                          </a>
                              ...
                              <div class="special-card">
                                 <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-6">
                                       <div class="special-menu-text">
                                          <a href="menu-details.html">
                                             <h3><?php  echo $this->lang->line('25') ?></h3>
                                          </a>
                                          <p><?php  echo $this->lang->line('22') ?></p>
                                       </div>
                                    </div>
                                 ...
                                 <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-6">
                                       <div class="special-menu-text">
                                          ...
                                          <p><?php  echo $this->lang->line('26') ?></p>
                                       </div>
                                    </div>
                                    <div class="col-lg-3 col-2">
                                       <div class="special-menu-number">
                              ...
                              <div class="special-card">
                                 <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-6">
                                       <div class="special-menu-text">
                                          <a href="menu-details.html">
                                             <h3><?php  echo $this->lang->line('27') ?></h3>
                                          </a>
                                          <p><?php  echo $this->lang->line('28') ?></p>
                                       </div>
                                    </div>
                                    <div class="col-lg-3 col-2">
                                       <div class="special-menu-number">
            ...
            <div class="row">
               <div class="col-lg-2 col-12 col-sm-2 col-md-2" data-cues="fadeIn" data-duration="1500">
                  <div class="fun-odometer">
                     ...
                     <p><?php  echo $this->lang->line('31') ?></p>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-lg-3 col-6 col-sm-3 col-md-3" data-cues="fadeIn" data-duration="1500">
                        <div class="fun-odometer">
                           ...
                           <p><?php  echo $this->lang->line('32') ?></p>
                        </div>
                     </div>
                     <div class="col-lg-3 col-6 col-sm-3 col-md-3" data-cues="fadeIn" data-duration="1500">
                        <div class="fun-odometer">
                     ...
                     <div class="col-lg-3 col-6 col-sm-3 col-md-3" data-cues="fadeIn" data-duration="1500">
                        <div class="fun-odometer">
                           ...
                           <p><?php  echo $this->lang->line('34') ?></p>
                        </div>
                     </div>
                     <div class="col-lg-3 col-6 col-sm-3 col-md-3" data-cues="fadeIn" data-duration="1500">
                        <div class="fun-odometer">
                           ...
                           <p><?php  echo $this->lang->line('35') ?></p>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="row align-items-center">
               <div class="col-lg-6 col-md-6">
                  <div class="single-testimonials-content">
                     <div class="section-title left-title">
                        <span class="top-title"><?php  echo $this->lang->line('36') ?></span>
      ...
      <div class="portfolio-area pt-100 pb-100 jarallax" data-jarallax='{"speed": 0.3}'>
         <div class="container">
            <div class="section-title">
               <span class="top-title"><?php  echo $this->lang->line('41') ?></span>
               <h2><?php  echo $this->lang->line('42') ?></h2>
            </div>
            ...
            <div class="row">
               <div class="col-lg-3 col-sm-6 col-md-6" data-cue="slideInUp">
                  <div class="footer-widget">
                     ...
                     <p><?php  echo $this->lang->line('43') ?></p>
               ...
               <div class="col-lg-3 col-sm-6 col-md-6" data-cue="slideInUp">
                  <div class="footer-widget">
                     ...
                     <ul class="footer-list">
                        <li>
                           <i class='bx bxs-downvote'></i><a href="about.php"><?php  echo $this->lang->line('44') ?></a>
                        </li>
                        <li>
                           <i class='bx bxs-downvote'></i><a href="menu.php"><?php  echo $this->lang->line('45') ?></a>
                        </li>
                        <li>
                           <i class='bx bxs-downvote'></i><a href="booking-table.php"><?php  echo $this->lang->line('46') ?></a>
                        </li>
                        <li>
                           <i class='bx bxs-downvote'></i><a href="contact.php"><?php  echo $this->lang->line('47') ?></a>
                        </li>
                        <li>
                           <i class='bx bxs-downvote'></i><a href="gallery.php"><?php  echo $this->lang->line('48') ?></a>
                        </li>
                     </ul>
                  </div>
               </div>
               <div class="col-lg-3 col-sm-6 col-md-6" data-cue="slideInUp">
                  <div class="footer-widget footer-services">
                     <h2><?php  echo $this->lang->line('49') ?></h2>
                     <ul class="footer-list">
                        <li>
                           <?php  echo $this->lang->line('50') ?> <span>08:00 AM – 05:00 PM</span>
                        </li>
                        <li>
                          <?php  echo $this->lang->line('61') ?> <span>09:00 AM – 06:00 PM</span>
                        </li>
                        <li>
                          <?php  echo $this->lang->line('62') ?><span>10:00 AM – 05:00 PM</span>
                        </li>
                        <li>
                        <?php  echo $this->lang->line('63') ?><span>09:00 AM – 05:00 PM</span>
                        </li>
                        <li>
                          <?php  echo $this->lang->line('64') ?> <span>Closed</span>
                        </li>
                     </ul>
                  </div>
               </div>
               <div class="col-lg-3 col-sm-6 col-md-6" data-cue="slideInUp">
                  <div class="footer-widget">
                     <h2><?php  echo $this->lang->line('65') ?></h2>
                     ...
                     <div class="footer-item">
                        ...
                        <a href="mailto:restaurant@gmail.com"><span><?php  echo $this->lang->line('66') ?></span></a>
                     </div>
                     <div class="footer-item">
                        <i class='bx bx-map'></i>
                        <p><?php  echo $this->lang->line('67') ?></p>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="copyright-content">
         <p>© <?php echo date('Y'); ?> <?php  echo $this->lang->line('68') ?> <a href="https://amoriotech.com/" target="_blank">Amorio Technologies</a></p>
      </div>
      <div class="go-top">
        ...
        $(document).on('click','.add_items',function(){
           $('#insert_data').submit(function (event) {
            ...
            $.ajax({
               type:"POST",
               dataType:"json",
               url:"<?php //echo base_url(); ?>hotel/insert",
