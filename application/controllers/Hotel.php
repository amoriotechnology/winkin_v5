...
class Hotel extends CI_Controller {
	...
	public function index()
	{
		...
		$settinginfo=$this->hotel_model->settinginfo();
		$data['settinginfo']=$settinginfo;
		$data['currency']=$this->hotel_model->currencysetting($settinginfo->currency);
		$data['menu_items'] = $this->hotel_model->view_menu_items();
		$data['count_products'] = $this->hotel_model->count_items();
		$this->session->set_userdata('site_lang',  "english");
		// print_r($data['count_products']); die();
		// echo "<pre>"; print_r($data['menu_items']); echo "</pre>";
		$data['cat_items'] = $this->hotel_model->view_cat_items();
		$data['catsub_items'] = $this->hotel_model->view_catsub_items();
...
function _alpha_dash_space($str_in = '',$fields=''){
    ...
    public function checkout(){
	    ...
	    $data['cart_items'] = $this->hotel_model->checkout_cart_items();
	    $data['count_products'] = $this->hotel_model->count_items();
        $settinginfo=$this->hotel_model->settinginfo();
		$data['settinginfo']=$settinginfo;
		$data['currency']=$this->hotel_model->currencysetting($settinginfo->currency);
        ...
        $this->db->insert('order_items', $insert_data);
    ...
    public function cart(){
    	$data['cart_items'] = $this->hotel_model->cart_items();
    	$data['count_products'] = $this->hotel_model->count_items();
    	$settinginfo=$this->hotel_model->settinginfo();
		$data['settinginfo']=$settinginfo;
		$data['currency']=$this->hotel_model->currencysetting($settinginfo->currency);
    ...
    {  
    	...
    	$customerid = $this->session->userdata('UserID');
    	$data['count_products'] = $this->hotel_model->count_items();
    	$data['order_details'] = $this->hotel_model->order_items_fetch($customerid);
    	$settinginfo=$this->hotel_model->settinginfo();
		$data['settinginfo']=$settinginfo;
		$data['currency']=$this->hotel_model->currencysetting($settinginfo->currency);
    ...
    {
        $data['delete_items'] = $this->hotel_model->delete_cart_items($id);
...
public function subscribe(){
	...
	public function bookTable(){
        ...
        $this->db->update('rest_table', $data_status);
        // echo $this->db->last_query(); die();
        // redirect(base_url('viewtable'));
        // redirect(base_url('hotel'));

		$data['content']=$this->load->view('booktable',$data,TRUE);
		$this->load->view('booktable',$data);
	}
	...
	public function viewTable(){
		...
		$data['tableinfo'] = $this->hotel_model->view_table_count(); 
		// echo '<pre>'; print_r($data['tableinfo']);echo '</pre>';
		$data['content']=$this->load->view('viewtable',$data,TRUE);
		$this->load->view('viewtable',$data);
	}

	public function menuDetails($ProductsID)
	{
		$data['title']='Menu Details';
		$settinginfo=$this->hotel_model->settinginfo();
		$data['settinginfo']=$settinginfo;
		$data['currency']=$this->hotel_model->currencysetting($settinginfo->currency);
		$data['view_items'] = $this->hotel_model->view_product_items($ProductsID);
		// print_r($data['view_items']);
		$data['content']=$this->load->view('menudetails',$data,TRUE);
		$this->load->view('menudetails',$data);
	}

	public function insert_items($ProductsID)
	{
		$view_items = $this->hotel_model->view_product_items($ProductsID);
		// echo $quantity; die('hh');
	...
	{  
		...
		$view_items = $this->hotel_model->cart_delete($customerid);
	}
    ...
    public function orderdetails()
    {
		...
		$data['settinginfo']=$settinginfo;
		$data['currency']=$this->hotel_model->currencysetting($settinginfo->currency);
    	$data['order_status'] = $this->hotel_model->status_order($customerid);
